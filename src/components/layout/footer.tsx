        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://github.com/DURGESH-TRIPATHI-CODER" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                <GithubIcon className="h-5 w-5" />
                <span className="sr-only">GitHub</span>
              </a>
              <a href="https://x.com/DurgeshTri2580" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                <TwitterIcon className="h-5 w-5" />
                <span className="sr-only">X (Twitter)</span>
              </a>
              <a href="https://www.instagram.com/durgesh_tripathi2580/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="https://github.com/DURGESH-TRIPATHI-CODER/Youtube-Downloader" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5 group">
                  Repository <ExternalLink className="w-3 h-3 opacity-50 group-hover:opacity-100 transition-opacity" />
                </a>
              </li>
              <li>
                <a href="https://github.com/DURGESH-TRIPATHI-CODER/Youtube-Downloader/issues" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5 group">
                  Report an Issue <ExternalLink className="w-3 h-3 opacity-50 group-hover:opacity-100 transition-opacity" />
                </a>
              </li>
              <li>
                <a href="https://github.com/DURGESH-TRIPATHI-CODER/Youtube-Downloader/issues/new" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5 group">
                  Feature Request <ExternalLink className="w-3 h-3 opacity-50 group-hover:opacity-100 transition-opacity" />
                </a>
              </li>
              <li className="pt-2">
                <a href="https://github.com/DURGESH-TRIPATHI-CODER/Youtube-Downloader" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-xs font-semibold bg-muted/50 hover:bg-muted text-foreground border border-border/50 px-2.5 py-1 rounded-md transition-all">
